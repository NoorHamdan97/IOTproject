...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // keeps a user logged in to the application
//        FirebaseUser FBuser = FBauth.getCurrentUser();//indicates if a user's already logged in
//        if (FBuser!=null){
//            finish();//destroying the activity and moving on to another activity
//            ///nextactivty
//            Intent intent = new Intent(MainActivity.this, LuggageActivity.class);
